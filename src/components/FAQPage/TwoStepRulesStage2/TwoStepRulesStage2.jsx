...
import TwoStepRulesStage2Qns from "./TwoStepRulesStage2Qns.jsx";
import { ChevronRight } from "lucide-react";
import { Card, CardContent } from "../Card.jsx";
import { Link } from "react-router-dom";

export default function TwoStepRulesStage2() {
  return (
    <div className="max-w-2xl mx-auto p-4">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Two Step Rules - Stage 2</h1>
      ...
      <p className="text-sm text-gray-500 mb-4">
        {TwoStepRulesStage2Qns.length} articles
      </p>

      {TwoStepRulesStage2Qns.map((item, id) => (
        <Card
          key={item.id}
        ...
        >
          <CardContent className="p-4">
            <Link
              to={`/faq/twostep-rules-stage-2/${item.routerLink}`}
